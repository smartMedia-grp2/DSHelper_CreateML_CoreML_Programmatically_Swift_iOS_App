...
//            print("classifications OK")
            ...
            if classifications.isEmpty{
                ...
                if (predictedDS == "001"){
                    ...
                    "HK$146.31" + "- \(predictedDS)" + "\n\n" + "Supplement Facts\n\nServing Size:" +
                    "2 Veggie Capsules" + "\nServings Per Container:" +
                    "60" + "\n\nAmount Per Serving\n" +
                    "Zinc (from PepZin GI Zinc-L-Carnosine)    16 mg" + "\n" +
                    "Zinc-L-Carnosine (from PepZin GI Zinc-L-Carnosine)    75 mg" + "\n" +
                    "L-Carnosine (from PepZin GI Zinc-L-Carnosine)    59 mg" + "\n\nSuggested use\n" +
                    ...
                    self.scanned = UserDefaults.standard.bool(forKey: "Key2")
                    let DSDesc =
                    "NOW Foods, D-Mannose, 500 mg, 120 Veg Capsules" +
                    "HK$118.67" + "- \(predictedDS)" + "\n\n" + "Supplement Facts\n\nServing Size:" +
                    "3 Veg Capsules" + "\nServings Per Container:" +
                    "40" + "\n\nAmount Per Serving\n" +
                    "Calories    5" + "\n" +
                    "Total Carbohydrate    1.5 g" + "\n" +
                    "Total Sugars    1.5 g" + "\n" +
                    "D-Mannose    1.5 g (1,500 mg)" + "\n\nSuggested use\n" +
                    ...
                    "HK$146.90" + "- \(predictedDS)" + "\n\n" + "Supplement Facts\n\nServing Size:" +
                    "1 Tablespoon (15 ml)" + "\nServings Per Container:" +
                    "32" + "\n\nAmount Per Serving\n" +
                    "Calories    130" + "\n" +
                    "Total Fat    14 g" + "\n" +
                    "Saturated Fat    13 g" + "\n" +
                    "Medium Chain Triglycerides    14 g" + "\n" +
                    "Caprylic Acid    7.7 g" + "\n" +
                    "Capric Acid    5.0 g" + "\n\nSuggested use\n" +
                    "Adults take 1 tablespoon (15 ml) 1-3 times daily as needed.\nMixes into smoothies, shakes, coffee, and other beverages.\nAdd to your favorite foods such as salads, yogurt, and more.\nNo refrigeration required."
                    UserDefaults.standard.set(DSDesc, forKey: "Key") //setObject
                    showScanned()
                    self.scanned = true
                    UserDefaults.standard.set(String(predictedDS), forKey: "DS_ID") //setObject
