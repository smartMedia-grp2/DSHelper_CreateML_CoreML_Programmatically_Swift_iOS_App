...
class ScannedViewController: UIViewController {
    ...
    var DSName = UserDefaults.standard.string(forKey: "DSName") ?? "Here is DSName..."
    var DSDesc = UserDefaults.standard.string(forKey: "DSDesc") ?? "Here is DSDesc..."
    var DS_ID = UserDefaults.standard.string(forKey: "DS_ID") ?? "-1"
    /* Voice2 */
